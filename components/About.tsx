  ...
  return (
    <section id="about" className="mt-24 lg:grid lg:grid-cols-[0.95fr,1.05fr] lg:items-center lg:gap-16">
      <div className="rounded-[2rem] border border-white/10 bg-[#101125]/90 p-8 shadow-[0_35px_80px_rgba(0,0,0,0.25)] backdrop-blur-xl">
        ...
        <div className="mt-8">
          <a href="/Fronzen548_Resume.pdf" download className="inline-flex items-center gap-3 rounded-full bg-neonpurple px-6 py-3 font-semibold text-black shadow-[0_20px_60px_rgba(124,77,255,0.2)] transition hover:brightness-110">
            Завантажити CV
          </a>
        </div>
      </div>
